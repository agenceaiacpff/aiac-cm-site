...
export default async function MyPositionPage(){
 ...
 const{data:profile}=await supabase.from("profiles").select("id,status,registration_state,must_reset_password,role").eq("id",userId).single();
